...
def api_config():
    ...
    return jsonify({
        ...
        "example_queries": [
            ...
            {"category": "Base Filters",
             "query": 'event.kind:"alert" AND event.outcome:"failure"',
             "description": "Alerts where the action failed / was blocked"},
            # ── Severity ────────────────────────────────────────────────────
            {"category": "Severity",
            ...
            {"category": "Severity",
             "query": 'suricata.alert.severity:3',
             "description": "Low severity / informational alerts (sev 3)"},
            ...
            {"category": "Threat Classification",
             "query": 'rule.name:(*SCAN* OR *RECON* OR *PROBE*)',
             "description": "Reconnaissance / scanning activity"},
            {"category": "Threat Classification",
             "query": 'rule.name:(*PHISHING* OR *SPYWARE* OR *RANSOMWARE*)',
             "description": "Phishing, spyware, or ransomware detections"},
            {"category": "Threat Classification",
             "query": 'rule.name:(*POLICY* OR *INAPPROPRIATE*)',
             "description": "Policy violations (unauthorized tools, etc.)"},
            # ── Network Protocol ─────────────────────────────────────────────
            ...
            {"category": "Network Protocol",
             "query": 'event.kind:"alert" AND network.application:"http"',
             "description": "HTTP traffic alerts"},
            {"category": "Network Protocol",
             "query": 'event.kind:"alert" AND network.application:"tls"',
             "description": "TLS / HTTPS traffic alerts"},
            {"category": "Network Protocol",
             "query": 'event.kind:"alert" AND network.transport:"icmp"',
             "description": "ICMP (ping / traceroute) based alerts"},
            {"category": "Network Protocol",
             "query": 'event.kind:"alert" AND network.transport:"udp"',
             "description": "UDP traffic alerts"},
            # ── Port ──────────────────────────────────────────────────────────
            {"category": "Port",
             "query": 'destination.port:22 AND event.kind:"alert"',
             "description": "Alerts targeting SSH (port 22)"},
            {"category": "Port",
             "query": 'destination.port:3389 AND event.kind:"alert"',
             "description": "Alerts targeting RDP (port 3389)"},
            {"category": "Port",
             "query": 'destination.port:(445 OR 139) AND event.kind:"alert"',
             "description": "Alerts targeting SMB (ports 445 / 139)"},
            {"category": "Port",
             "query": 'destination.port:443 AND event.kind:"alert"',
             "description": "Alerts on HTTPS port 443"},
            {"category": "Port",
             "query": 'destination.port:53 AND event.kind:"alert"',
             "description": "DNS port 53 alerts"},
            # ── Geolocation ─────────────────────────────────────────────────
            {"category": "Geolocation",
             "query": '_exists_:source.geo.country_iso_code AND event.kind:"alert"',
             "description": "Alerts with a known source country (GeoIP enriched)"},
            {"category": "Geolocation",
             "query": 'source.geo.country_iso_code:"CN" AND event.kind:"alert"',
             "description": "Traffic sourced from China (CN)"},
            {"category": "Geolocation",
             "query": 'source.geo.country_iso_code:"RU" AND event.kind:"alert"',
             "description": "Traffic sourced from Russia (RU)"},
            # ── IP Presence ──────────────────────────────────────────────────
            {"category": "IP Presence",
             "query": '_exists_:source.ip AND event.kind:"alert"',
             "description": "Any alert that has a source IP (filter to investigate IPs)"},
            {"category": "IP Presence",
             "query": '_exists_:destination.ip AND event.kind:"alert"',
             "description": "Any alert with a destination IP (lateral movement hunting)"},
        ],
    })
